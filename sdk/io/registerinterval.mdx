...
description: "`io.registerInterval()` allows you to register a [DynamicSchedule](/sdk/dynamic-schedule) that will trigger any jobs it's attached to on a regular interval."
---
...
<ResponseField name="dynamicSchedule" type="DynamicSchedule" required>
  A [DynamicSchedule](/sdk/dynamic-schedule) that will trigger any Jobs it's
