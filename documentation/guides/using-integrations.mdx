...
## Passing Integrations into your Jobs

You must pass Integrations into your Job. Passed in Integrations will be available on the `io` object in the `run()` function with the same name as the key. For example:
